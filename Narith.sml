...
(form_goal “?LESS0. LESS0 = NEQ o LESS2NEQ”)
...
(rpt strip_tac >> assume_tac INDUCT_one_component >>
 first_x_assum (qspecl_then ["f o π2(N,N)","g o π2(N,N)","ZERO"] assume_tac) >>
 fs[o_assoc,pa2Pa,pi12_of_Pa])
(form_goal
